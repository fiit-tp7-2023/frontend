<template>
  <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 grid lg:grid-cols-2 gap-8 column-2">
      ...
      <div class="flex justify-center items-center mt-3 mr-11">
        <n-button
          class="content-center ml-auto text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
          type="info"
          @click="$router.push('/project/login')"
          >Project section</n-button
        >
      </div>
    </div>
    <team-members />
